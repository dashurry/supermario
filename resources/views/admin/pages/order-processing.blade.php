            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Processing Orders ({{ count($processing_orders) }})</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($processing_orders as $order)
                                        <tr>
                                            ...
                                            <td>{{ $order->email }}</td>
                                            <td>{{ $order->phone }}</td>
                                            <td data-live-time="{{ $order->created_at }}">{{ $order->created_at->diffForHumans() }}</td>
                        ...
                        <div class="row justify-content-center">
                            {{ $processing_orders->links('pagination::bootstrap-4') }}
                        </div>
                    </div>
                </div>
            </div>
